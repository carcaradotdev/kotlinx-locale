...
class CurrencyAmountSerializersTest {

    private val forms = listOf<KSerializer<CurrencyAmount>>(
    ...
    @Test
    fun writesEachFormAsDocumented() {
    ...
    @Test
    fun carriesTheFractionDigitsOfTheCurrency() {
    ...
    @Test
    fun roundTripsThroughEveryForm() {
        val amounts = listOf(
    ...
    @Test
    fun readsTheObjectFormsInAnyFieldOrder() {
    ...
    @Test
    fun rejectsMoreFractionDigitsThanTheCurrencyHas() {
    ...
    @Test
    fun rejectsALocaleFormattedAmount() {
    ...
    @Test
    fun rejectsAMalformedCombinedString() {
    ...
    @Test
    fun theCombinedStringIsWhatToStringWrites() {
    ...
    @Test
    fun theDecimalFormSurvivesAScaleItsReaderDoesNotShare() {
    ...
    @Test
    fun servesAsAMapKeyInItsCombinedForm() {
    ...
    @Test
    fun everyActiveCurrencyRoundTripsThroughTheDecimalForms() {
