...
class LocaleTest {
    ...
    @Test
    fun exposesAvailableLocales() {
        val tags = Locale.availableLocales.map(Locale::toLanguageTag)
    ...
    fun currentLocaleIsAlwaysUsable() {
        ...
        // Whatever the platform reports must be formattable end to end.
        val formatted = kotlinx.datetime.LocalDate(2026, 7, 27).format(FormatStyle.MEDIUM, current)
