...
val PhoneNumberSerializersTest by matrixSuite {
    ...
    fun encode(serializer: kotlinx.serialization.KSerializer<PhoneNumber>) = Json.encodeToString(serializer, number)

    test("eachFormWritesItsOwnSpelling") {
    ...
    test("eachFormReadsBackWhatItWrote") {
    ...
    test("theLenientOneReadsEveryFormAndWritesE164") {
    ...
    test("thePartsFormNeedsNoMetadata") {
    ...
    test("thePartsFormKeepsALeadingZero") {
    ...
    test("anExtensionSurvivesTheFormsThatCarryOne") {
    ...
    test("rubbishIsRejectedRatherThanGuessedAt") {
    ...
    test("aNationalFormIsReadAgainstItsDeclaredRegion") {
