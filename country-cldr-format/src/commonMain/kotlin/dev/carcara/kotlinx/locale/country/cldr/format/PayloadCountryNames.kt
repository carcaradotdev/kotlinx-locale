...
package dev.carcara.kotlinx.locale.country.cldr.format
 ...
 * about, which is the whole point of the module: the shipped `-cldr` artifact
 * hands it the full 1121-locale set, and a build that generated a narrowed set
 * hands it that instead. Both get the same lookup, so a narrowed build cannot
 * resolve names differently from a full one.
 *
