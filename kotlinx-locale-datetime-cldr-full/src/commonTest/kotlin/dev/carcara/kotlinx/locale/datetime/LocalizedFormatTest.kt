...
val LocalizedFormatTest by matrixSuite {
    ...
    test("formatsDatesInBritishEnglish") {
    ...
    test("formatsWithNonLatinDigits") {
    ...
    test("stripsZoneFieldsFromZonelessTimeStyles") {
    ...
    test("formatsDateTimesWithGluePattern") {
    ...
    test("formatsMixedDateTimeStyles") {
        assertEquals(
    ...
    test("fallsBackThroughTheLocaleChain") {
