...
import dev.carcara.kotlinx.locale.internal.availableLocaleTags
...
public class Locale private constructor(
    ...
    public companion object {
        ...
        /** Every locale CLDR provides data for, sorted by tag. */
        public val availableLocales: List<Locale> by lazy {
            availableLocaleTags.map { forLanguageTag(it) }
        }
    }
}
