...
class SkeletonFormatTest {

    @Test
    fun `the same fields are arranged differently per locale`() {
    ...
    @Test
    fun `a skeleton is order independent`() {
        assertEquals(
    ...
    @Test
    fun `hour and minute widths stay the locale's`() {
    ...
    @Test
    fun `j resolves to the locale's preferred hour`() {
    ...
    @Test
    fun `capital J asks for an hour with no day period`() {
    ...
    @Test
    fun `quarters render from the skeleton tables`() {
    ...
    @Test
    fun `a date and time request is joined with the locale's glue`() {
    ...
    @Test
    fun `an unrenderable field is refused rather than dropped`() {
    ...
    @Test
    fun `every locale answers the ids CLDR declares everywhere`() {
