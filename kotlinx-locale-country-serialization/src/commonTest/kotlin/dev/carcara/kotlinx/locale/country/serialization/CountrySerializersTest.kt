...
val CountrySerializersTest by matrixSuite {
    ...
    test("roundTripsEveryCountryThroughEverySerializer") {
    ...
    test("theNamedSerializersRejectTheOtherForms") {
    ...
    test("theLenientSerializerReadsAllThreeSpellings") {
    ...
    test("theThreeCodeSpacesDoNotOverlap") {
    ...
    test("theLenientSerializerAlwaysWritesAlphaTwo") {
    ...
    test("theDefaultPluginEncodingIsAlreadyAlphaTwo") {
